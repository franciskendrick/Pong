...
def set_gamemode_loop():
    ...
    btn_switchcase = {
        "singleplayer": [
            ...
            sp_game_loop  # redirect to singleplayer game loop
        ],
        "multiplayer": [
            sound.play_buttonclick,  # play sound
            gamemode.buttons.reset_overdetection,  # reset gamemode's buttons' over detection
            game_reset,  # reset game variables
            mp_game_loop  # redirect to multiplayer game loop
        ],
    }
...
def pause_loop(on_multiplayer):
    # Get game loop
    game_loop = mp_game_loop if on_multiplayer else sp_game_loop
...
def gameover_loop(on_multiplayer):
    # Get game loop
    game_loop = mp_game_loop if on_multiplayer else sp_game_loop
